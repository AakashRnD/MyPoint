/* Description:-To handle the database for Questions of Point Multiple choice Question
...
package com.example.pointquiz.database;
...
public class DataBaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE pointQuestions(qid INTEGER, question TEXT, a TEXT, b TEXT, c TEXT, d TEXT, explanation TEXT)");
	}

	@Override
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		// TODO Auto-generated method stub
		db.execSQL("DROP TABLE IF EXISTS pointQuestions");
...
//Add questions to the Table------------------------
	public void addQuestion(Question q){
	 ...
	 // Inserting Row
	    db.insert("pointQuestions", null, values);
...
//Get single question from Table--------------------
	public Question getQuestion(int id){
		...
		String query = "SELECT * FROM pointQuestions WHERE qid = ?";
...
public void remove(){
		...
		SQLiteDatabase db = this.getReadableDatabase();
		db.execSQL("DELETE FROM pointQuestions");
