...
public class Explanation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.linequiz_activity_explanation);
		...
		q1 = db.getQuestion(com.example.linetest.MainActivity.id_final[i]);
		
		q.setText(q1.get_question());
		corr.setText(Html.fromHtml("<br>The correct answer is " + "<b><font color=green >" + q1.get_optiona() + "</font></b>"));
		if(com.example.linetest.MainActivity.ansSelected[i]!=-1)
			sel.setText(Html.fromHtml("You selected: "+"<b><font color=blue>"+com.example.linetest.MainActivity.selectedAns[i]+"</font></b>"));
		else
		...
		if(com.example.linetest.LaunchScreen.number_questions==1)next.setVisibility(View.INVISIBLE);
	}
...
//NEXT BUTTON--------------
	public void next(View v){
		...
		if(i<com.example.linetest.LaunchScreen.number_questions-1){		
			previous.setVisibility(View.VISIBLE);
			next.setVisibility(View.VISIBLE);
			i++;
		
		if(i==com.example.linetest.LaunchScreen.number_questions-1)	next.setVisibility(View.INVISIBLE);
...
public void previous(View v){
		...
		if(com.example.linetest.MainActivity.ansSelected[i]!=-1)
			sel.setText(Html.fromHtml("You selected: "+"<b><font color=blue>"+com.example.linetest.MainActivity.answers_final[i][com.example.linetest.MainActivity.ansSelected[i]-1]+"</font></b>"));
		else
			sel.setText(Html.fromHtml("<font color=red>"+"You did not select an option"+"</font>"));
		exp.setText(Html.fromHtml("<i><b><br>Explanation:<br> "+"</b></i>"+q1.get_explanation()));
