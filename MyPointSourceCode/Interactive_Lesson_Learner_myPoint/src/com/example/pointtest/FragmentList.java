/* Description:-Display list of Questions for test
...
import com.example.pointtest.DummyContent;
...
public class FragmentList extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dc.remove();
		dc.add();
		ArrayAdapter<DummyContent.DummyItem> ad = new ArrayAdapter<DummyContent.DummyItem>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, dc.ITEMS) ;
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(dc.ITEMS.get(position).id);
	}
