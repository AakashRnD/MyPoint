...
class DrawView extends View{
	...
	int correct = com.example.finaleasy.MainActivity.correct;
	int wrong = com.example.finaleasy.MainActivity.wrong;
	int unanswered = com.example.finaleasy.MainActivity.unanswered;
	float canvas_width;
	float canvas_height;
...
public class Results extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		com.example.finaleasy.MainActivity.unanswered=0;
		com.example.finaleasy.MainActivity.wrong=0;
		com.example.finaleasy.MainActivity.correct=0;
		
		for(int i=0 ;i<15 ;i++){
			switch (com.example.finaleasy.MainActivity.answerState[i]){
			case 0:
				com.example.finaleasy.MainActivity.unanswered++;
		break;
			case	 1:
		com.example.finaleasy.MainActivity.correct++;
			break;
			case -1:
				com.example.finaleasy.MainActivity.wrong++;
		break;
			}	
		}
