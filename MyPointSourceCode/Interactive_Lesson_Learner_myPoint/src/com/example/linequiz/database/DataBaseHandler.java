/* Description:-To handle the database for Questions of Line Multiple choice Question
...
public class DataBaseHandler extends SQLiteOpenHelper {
	...
	public DataBaseHandler(Context context) {
		...
		super(context, "LineQuestions", null, 1);
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE lineQuestions(qid INTEGER, question TEXT, a TEXT, b TEXT, c TEXT, d TEXT, explanation TEXT)");		
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		// TODO Auto-generated method stub
		db.execSQL("DROP TABLE IF EXISTS lineQuestions");
...
//Add questions to the Table------------------------
	public void addQuestion(Question q){
	 ...
	 // Inserting Row
	    db.insert("lineQuestions", null, values);
...
//Get single question from Table--------------------
	public Question getQuestion(int id){
		...
		String query = "SELECT * FROM lineQuestions WHERE qid = ?";
	...
	public void remove(){
		...
		SQLiteDatabase db = this.getReadableDatabase();
		db.execSQL("DELETE FROM lineQuestions");
