/* Description:-To handle the database for Questions of Quiz-It Advanced Level
...
package com.example.finaltough.database;
...
public class DataBaseHandler extends SQLiteOpenHelper {
	...
	public DataBaseHandler(Context context) {
		...
		super(context, "FinalTough", null, 1);
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE FinalTough(qid INTEGER, question TEXT, a TEXT, b TEXT, c TEXT, d TEXT, explanation TEXT)");		
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		// TODO Auto-generated method stub
		db.execSQL("DROP TABLE IF EXISTS FinalTough");
...
//Add questions to the Table------------------------
	public void addQuestion(Question q){
	 ...
	 // Inserting Row
	    db.insert("FinalTough", null, values);
...
//Get single question from Table--------------------
	public Question getQuestion(int id){
		...
		String query = "SELECT * FROM FinalTough WHERE qid = ?";
	...
	public void remove(){
		...
		SQLiteDatabase db = this.getReadableDatabase();
		db.execSQL("DELETE FROM FinalTough");
