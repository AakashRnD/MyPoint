/* Description:-Display the result of Quiz
...
class DrawView extends View{
	...
	int correct = com.example.finaltough.MainActivity.correct;
	int wrong = com.example.finaltough.MainActivity.wrong;
	int unanswered = com.example.finaltough.MainActivity.unanswered;
	float canvas_width;
	float canvas_height;
	...
	//Drawing pie-graph	
		...
		canvas.drawArc(rectf, 0,correct*360/15 , true, paint);
		
		paint.setColor(Color.RED);
		canvas.drawRect(260, canvas.getHeight()/2-20, 280, canvas.getHeight()/2, paint);
		canvas.drawArc(rectf, correct*360/15,wrong*360/15 , true, paint);
...
public class Results extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		com.example.finaltough.MainActivity.unanswered=0;
		com.example.finaltough.MainActivity.wrong=0;
		com.example.finaltough.MainActivity.correct=0;
		
		for(int i=0 ;i<15 ;i++){
			switch (com.example.finaltough.MainActivity.answerState[i]){
			case 0:
				com.example.finaltough.MainActivity.unanswered++;
		break;
			case	 1:
		com.example.finaltough.MainActivity.correct++;
			break;
			case -1:
				com.example.finaltough.MainActivity.wrong++;
		break;
			}	
		}
